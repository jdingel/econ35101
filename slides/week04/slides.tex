...
%\quad
%S_i = w_i^{1-\sigma} \Rightarrow \Omega_i = w_i^\sigma/L_i
\end{equation*}
%This is structural gravity with $S_i = w_i^{1-\sigma} \Rightarrow \Omega_i = w_i^\sigma/L_i$
\end{frame}
% -----------------------------------------
...
\begin{center} Port Productivity, 1953-1980 \begin{figure}\includegraphics[width=.8\textwidth]{../images/Bridgman2014_fig2}\end{figure} \footnotesize{Tons handled per hour worked}\\\scriptsize{Bridgman, ``Why Containerization Did Not Reduce Ocean Trade Shipping Costs'', 2014} \end{center}
\end{frame}
% -----------------------------------------
\begin{frame}{Ocean transport costs}
\begin{center} Real Port Labor Cost per ton, 1953-1980 \begin{figure}\includegraphics[width=.8\textwidth]{../images/Bridgman2014_fig3}\end{figure} \footnotesize{Payments to labor per ton deflated by CPI}\\ \scriptsize{Bridgman, ``Why Containerization Did Not Reduce Ocean Trade Shipping Costs'', 2014}  \end{center}
\end{frame}
% -----------------------------------------
...
\begin{minipage}{.5\textwidth}\includegraphics[width=\textwidth]{../images/DoingBusinessTradingAcrossBorders.png} \\ \vfill \end{minipage}
\begin{minipage}{.35\textwidth}\includegraphics[width=\textwidth]{../images/DoingBusinessTradingAcrossBorders2.png}\end{minipage}
\begin{center}\href{http://www.doingbusiness.org/methodology/trading-across-borders}{methodology}\end{center}
\end{frame}
% -----------------------------------------
\begin{frame}{Doing Business: Trading across borders}
\begin{center}\includegraphics[width=.77\textwidth]{../images/DoingBusinessWhoMakesExportingEasy.png}\end{center}
\end{frame}
% -----------------------------------------
...
\begin{figure}
\includegraphics[width=.9\textwidth]{../images/Hortacsuetal_2009_tab8} \\
\end{figure}
\end{frame}
% -----------------------------------------
\begin{frame}{Geography of eBay transactions}
\begin{figure}
\includegraphics[width=.95\textwidth]{../images/Hortacsuetal_2009_tab9} \\
\end{figure}
\end{frame}
% -----------------------------------------
