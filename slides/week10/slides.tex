...
\begin{center}
\includegraphics[width=\textwidth]{../images/GlaeserGyourko2018_fig2c.pdf}\\
Glaeser \& Gyourko (JEP 2018)\end{center}
\end{frame}
% -----------------------------------------
\begin{frame}{Housing supply elasticities -- prices vs quantities}
\begin{center}
\includegraphics[height=\textheight]{../images/GlaeserGyourko2018_fig2.pdf}
\end{center}
\end{frame}
% -----------------------------------------
\begin{frame}{Incidence of building restrictions}
\begin{center}
\includegraphics[height=.85\textheight]{../images/GlaeserGyourko2018_fig4.pdf}\\
Glaeser \& Gyourko (JEP 2018)\end{center}
\end{frame}
% -----------------------------------------
